...
- [Santander Open Academy — Python (8 horas)](https://github.com/JoaoBrustolin-dev/DEV-Brustolin/blob/main/certificado-santander.pdf.pdf)
...
- [HTML e CSS — Posicionamento, Listas e Navegação](https://cursos.alura.com.br/certificate/brustolin-joao/html-css-posicionamento-listas-navegacao)
- [HTML5 e CSS3 — Criando uma Página Web (Parte 1)](https://cursos.alura.com.br/certificate/brustolin-joao/html5-css3-parte-1-pagina-web)
